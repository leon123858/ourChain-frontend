...
Future<String> sendMoney({double fee = 0.0001, String targetAddress = "", String privateKey = "", String ownerAddress = ""}) async {
  final rawTx = await createTx(fee: fee, targetAddress: targetAddress, ownerAddress: ownerAddress, contract: {'action': 0, 'code': '', 'address': '', 'args': []});
  if (rawTx == null) {
